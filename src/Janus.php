...
namespace Service\Janus;

use Service\Janus\Exceptions\JanusApiException;
...
class Janus
{
    ...
    public function ping(): array
    {
        ...
        if ('pong' === $this->server->getApiResponse('janus')) {
            return [
                'pong' => true,
     ...
     * @return mixed|null
     */
    public function getApiResponse(?string $key = null): mixed
    {
